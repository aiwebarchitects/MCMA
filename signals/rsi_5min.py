...
class RSI5MinSignalGenerator:
    """
    RSI-based signal generator using 5-minute candles.
    Each instance is standalone with its own parameters.
    """
    
    def __init__(self, period: int = 14, oversold: int = 30, overbought: int = 70):
        """
        Initialize RSI 5-minute signal generator.
    ...
    def _load_coin_parameters(self, coin: str):
        ...
        params = self.backtest_loader.get_parameters(coin, "rsi-5min")
